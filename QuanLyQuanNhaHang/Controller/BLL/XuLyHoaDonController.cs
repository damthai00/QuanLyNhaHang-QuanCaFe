    ...
    class XuLyHoaDonController
    {
        ...
        public List<HoaDonHienThi> loadHoaDon()
        {
            ...
            foreach(DataRow item in dt.Rows)
            {
                ...
                String id_khachhang = item["hoten"].ToString();
                String id_ban = item["ten_ban"].ToString();
        ...
        public bool updatTinhTienHoaDon(HoaDon hd)
        {
            return HoaDonController.Instance.updateTinhTienHoaDon(hd);
        }

        public bool updatSoTienHoaDon(HoaDon hd)
        {
            return HoaDonController.Instance.updateSoTienHoaDon(hd);
        }
