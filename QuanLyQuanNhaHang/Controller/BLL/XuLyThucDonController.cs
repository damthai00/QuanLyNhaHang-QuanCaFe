...
namespace QuanLyQuanCafe.Controller
{
    class XuLyThucDonController
    {
        ...
        public bool KiemTraThucDonDangSuDung(int id_thucdon)
        {
            DataTable dt = ThucDonController.Instance.getThucDonDangSuDung(id_thucdon);
            if (dt.Rows.Count > 0)
                return true;
            else
                return false;
        ...
        {
            return ThucDonController.Instance.getThucDonConHang();
        }
        ...
        {
            return ThucDonController.Instance.deleteThucDon(id_thucdon);
        }
